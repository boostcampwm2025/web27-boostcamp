...
export const ClickLog = ({ logs }: ClickLogProps) => {
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-neutral-900 mb-3">최근 클릭 로그:</h3>
      <div className="space-y-2">
        {logs.map((log, index) => (
          ...
          >
            <Icon name="clock" size={16} className="text-neutral-500 flex-shrink-0" />
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium text-neutral-900 truncate">{log.campaignName}</p>
