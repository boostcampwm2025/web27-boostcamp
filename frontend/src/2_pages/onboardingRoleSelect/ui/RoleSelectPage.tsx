...
import type { AccountType } from '@/3_features/authorize/register/model/types';
      ...
      <Modal height="h-[500px]">
        <form onSubmit={handleSubmit} className="flex h-full flex-col">
          <div className="px-8 pt-6">
            <div className="flex items-center justify-between text-[10px] font-semibold uppercase tracking-[0.3em] text-slate-400"></div>
          ...
          <div className="mt-auto flex items-center justify-between px-8 pb-8 pt-6">
            <p className="text-xs text-slate-400">추후에 수정이 불가능해요.</p>
            <button
              type="submit"
